...
An AI-powered document question-answering system built using **Google Gemini**, **LangChain**, **ChromaDB**, **Sentence Transformers**, and **Streamlit**.

The application allows users to upload PDF documents, automatically generate vector embeddings, perform semantic search, and answer questions with source citations using Retrieval-Augmented Generation (RAG).
